...
public:
    ...
    //Setter Function : Set value of r_value
    void setRvalue(size_t r)
    {
        r_value = r;
    }
...
private:
    ...
    //code for second hash function
    int hash2(const HashedObj& x)
    {
        static std::hash<HashedObj> hf;
        //h_value is the hash value
        int h_value = hf(x);						
        
        return r_value - (h_value % r_value);
    }
